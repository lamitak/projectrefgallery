...
CREATE TABLE IF NOT EXISTS image_sku_tags (
  image_id INTEGER NOT NULL,
  sku_id INTEGER NOT NULL,
  PRIMARY KEY (image_id, sku_id),
...
CREATE INDEX IF NOT EXISTS idx_image_sku_tags_sku ON image_sku_tags(sku_id);
CREATE INDEX IF NOT EXISTS idx_image_sku_tags_image ON image_sku_tags(image_id);
